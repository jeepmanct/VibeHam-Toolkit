...
| **Detail** | Tap any QSO to add a photo, POTA/SOTA reference, or view solar conditions for that QSO date |
...
| **Space** | Live solar flux, A/K index, sunspot number, plus historical GFZ Potsdam data sync |
